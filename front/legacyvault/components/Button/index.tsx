...
export default function Button({
    ...
    const button = role === 'edit' ? (
        <button className="w-[150px] h-[40px] border-input bg-white rounded justify-center items-center font-bold hover:bg-[#f0f0f0]" type="submit" onClick={onClick}>Edit</button>
    ) : role === 'delete' ? (
